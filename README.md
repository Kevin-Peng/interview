...
　五、全局唯一ID生成​​  
　　　方案对比​​：
      ![image](https://github.com/user-attachments/assets/7e6d0859-7c50-451f-9258-ca9b634aaee9)
...
4. 规则引擎逻辑设计
5. 在哪些场景下用到redis
6. redis出现热点key，或者穿透该怎么处理
7. redis里有某一个热点key，导致所有访问都落在这个key所在的节点上，出现瓶颈该怎么处理
8. mysql锁的机制，有哪些锁，一般用在哪些场景
9. 遇到过死锁吗？怎么解决死锁的问题
10. 怎么判断要不要加索引，怎么加索引
11. 处理过一些GC之类的问题吗
12. 招聘的这个岗位是做什么的？日常上下班时间？公司标准9：00-18：30，早上可以晚点一般不超过9：30

## 2025.08.19 小红书 电商-闭环广告
1. 自我介绍  
2. 项目难点  
3. 业务的QPS，如果QPS特别大怎么处理设计服务/数据库/中间件  
4. 服务CPU突然暴涨，100%怎么排查问题  
5. 上游大量实时性请求，怎么不丢失和延迟的情况下及时处理  
6. 算法题：  
   给定一个单链表的头节点  head ，其中的元素 按升序排序 ，将其转换为 平衡 二叉搜索树。  
   输入: head = [-10,-3,0,5,9]  
   输出: [0,-3,9,-10,null,5]  
   解释: 一个可能的答案是[0，-3,9，-10,null,5]，它表示所示的高度平衡的二叉搜索树。  
7. 上下班时间最晚早上10：30，晚上一般9点多到10点。  
